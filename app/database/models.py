...
class MatchAnalysisRequest(Base):
    ...
    match_start_at: Mapped[datetime | None] = mapped_column(DateTime, index=True)
    match_title: Mapped[str | None] = mapped_column(String(500))
...
class PlayerBirthday(Base):
    ...
    confidence: Mapped[str] = mapped_column(String(30), default="unverified", index=True)
    confidence_score: Mapped[int | None] = mapped_column(Integer)
    verification_status: Mapped[str] = mapped_column(String(30), default="new", index=True)
