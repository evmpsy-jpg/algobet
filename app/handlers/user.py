...
from app.database.models import ImportBatch, Match, MatchAnalysisRequest, ScheduledSignal, SignalDecisionLog, SignalResult, User, UserAccess
...
❌ На итог всей игры не ставим.
<b>Только один сет, до первой победы.</b>

<b>Подготовка банка</b>
Выделите на матч фиксированный стек: <b>1/10</b> (10%) или безопасные <b>1/20</b> (5%) от вашего общего баланса.
Введите сумму в калькулятор бота — он сам рассчитает размеры ставок, учитывая изначальный кф на сет.

<b>Работа по сигналу (Цикл из 3 шагов)</b>
Бот присылает сигнал за 10 мин. до матча.
Вы заходите в Live, видите КФ и ставите строго по цепочке:

<b>Шаг 1 (Ставка на 1-й сет ~ 10% от стека):</b>
<i>Плюс</i> 🎉 ➡️ Фиксируем прибыль. Матч окончен.
<i>Минус</i> ❌ ➡️ Переходим ко 2-му сету.

<b>Шаг 2 (Ставка на 2-й сет ~ 25% от стека):</b> Сумму повышаем по калькулятору бота.
<i>Плюс</i> 🎉 ➡️ Отыграли минус, с заложенной прибылью, вышли в чистый профит. Матч окончен.
<i>Минус</i> ❌ ➡️ Переходим к 3-му сету.

<b>Шаг 3 (Ставка на 3-й сет ~ 65% от стека):</b> Последнее перекрытие по калькулятору.
<i>Плюс</i> 🎉 ➡️ Закрыли весь цикл в плюс. Матч окончен.

<b>ИТОГО</b> <b>10% от общего банка</b> / <b>по-сетовый шаг зависит от кф на сет.</b>

<b>Что делать при осечке (минус на всех 3 шагах)?</b>
Такое бывает в 5% случаев из-за отсутствия мотивации у игрока.
<b>Защитный режим</b> — временно увеличиваем стек (<b>Х2</b>) на следующие 3–5 сигналов.
Восстанавливаем просадку и возвращаемся к первому шагу 10–5% от общего банка.

<b>⛔️ Табу:</b>
<b>Не трогаем финалы</b> турниров.
