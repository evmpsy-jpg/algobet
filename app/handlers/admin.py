...
def format_admin_settings_text(
    ...
    return (
        ...
        f"Автопубликация: {'включена' if settings.promo_results_auto_enabled else 'выключена'}\n"
        f"Свежий период: {settings.promo_results_auto_lookback_hours} ч.\n"
        f"Точка старта: {settings.promo_results_auto_start_at or 'не задана'}\n\n"
        "🔎 Анализ матча\n"
